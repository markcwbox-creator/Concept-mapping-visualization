 ...
 * diffed against each other. `tests/test_pipeline.py` checks that the Python and
...
export { dequantise, dot, distancesTo, distancesToVector, shortestPath, collide, distancePercentile };
